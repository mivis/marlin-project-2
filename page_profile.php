                            ...
                            <div class="col-12">
                                ...
                                <?php 
                                    if (has_avatar($user['id'])){?>
                                        <img src="uploads/avatar/<?=$user['avatar']?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <?php } else {?>
                                        <img src="uploads/avatar/avatar-default.png" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <?php }?>
