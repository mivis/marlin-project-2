                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <?php 
                                    if (has_avatar($user['id'])){?>
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('uploads/avatar/<?=$user['avatar'];?>'); background-size: cover;"></span>
                                     <?php } else {?>
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('uploads/avatar/avatar-default.png'); background-size: cover;"></span>                                        
                                    <?php }?>                                    
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="actions/delete_action.php?id=<?=$user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i><?=$user['vk_link'];?>
                                    </a>
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i><?=$user['tg_link'];?>
                                    </a>
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#E1306C">
                                        <i class="fab fa-instagram"></i><?=$user['inst_link'];?>
                                    </a>
                                </div>
                            </div>
                        </div>
