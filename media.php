...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="actions/media_action.php" enctype="multipart/form-data" method="post">
            <div class="row">
                <div class="col-xl-6">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <?php 
                                        ...
                                        <img src="uploads/avatar/<?=$user['avatar']?>" alt="" class="img-responsive" width="200">
                                        <?php } else {?>
                                        <img src="uploads/avatar/avatar-default.png" alt="" class="img-responsive" width="200">
                                    <?php }?>
                                </div>
